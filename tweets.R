...
api_key <- "FVNhsbVGYnuowORLBfKi40Mgx"
api_secret <- "bMpH2n7Cwpe3VXhgZb906wKQMGiXrlBZTZjt2mwzobrCjEuSmO"
access_token <- "99851061-90UpBC2HTFDHlSeRIMYxlBZg8uZM1cUPBhiBQ8aNH"
access_token_secret <- "ktId4loRxlTop3BawKUnEizJnhSGNG8BRnVoQYFxVfmBg"
...
getSentiment <- function (text, key){
  ...
  data <- getURL(paste("http://api.datumbox.com/1.0/TwitterSentimentAnalysis.json?api_key=", "d84fdcc766008d679e844f3906e144a1", "&text=",text, sep=""))
...
# get some tweets
tweets = searchTwitter(searchword, 20, lang="en")
# get text 
